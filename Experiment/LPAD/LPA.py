...
"""
The class performs Latent Profile Analysis for binary datasets
based on the code from : https://github.com/dasirra/latent-class-analysis
(includes documentation)
"""
class LPA:
    def __init__(self, n_components=2, tol=1e-3, max_iter=10, random_state=None):
